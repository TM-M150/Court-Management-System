...
?>
<h1 class="text-primary"><i class="fas fa-users"></i>  All Staff<small class="text-warning"> All Staff List!</small></h1>
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
     <li class="breadcrumb-item" aria-current="page"><a href="index.php">Dashboard </a></li>
     <li class="breadcrumb-item active" aria-current="page">All Saff</li>
  </ol>
</nav>
<?php if(isset($_GET['delete']) || isset($_GET['edit'])) {?>
  <div role="alert" aria-live="assertive" aria-atomic="true" class="toast fade" data-autohide="true" data-animation="true" data-delay="2000">
    <div class="toast-header">
      <strong class="mr-auto">Staff Insert Alert</strong>
...
<table class="table  table-striped table-hover table-bordered" id="data">
  ...
  <tbody>
    <?php 
      $query=mysqli_query($db_con,'SELECT * FROM `staff` ORDER BY `staff`.`datetime` DESC;');
      $i=1;
